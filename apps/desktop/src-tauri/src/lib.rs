...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::contracts::list_contractors,
            commands::contracts::ensure_contractor,
            commands::contracts::delete_contractor,
            ...
            commands::tariffs::confirm_tariff_import_batch,
            commands::tariffs::delete_tariff_import_draft_file,
            commands::tariffs::list_tariff_import_draft_summaries,
            commands::tariffs::load_tariff_import_draft,
            commands::tariffs::save_tariff_import_draft,
